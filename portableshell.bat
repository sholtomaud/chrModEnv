...
set PATH=%drivep%\perl\site\bin;%drivep%\perl\bin;%drivep%\c\bin;C:\Users\smaud\AppData\Local\GitHub\PortableGit_054f2e797ebafd44a30203088cd3d58663c627ef\;%PATH%
rem env variables
set TERM=
set HOME=%~dp0data
